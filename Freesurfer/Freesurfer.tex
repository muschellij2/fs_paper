...
including surface-based registration. The \pkg{ANTsR} package
...
After this file is a NIfTI file, we can read it into R, and then plot
the image:
...
when displaying using the \pkg{neurobase} \code{ortho2} function.
...
the \code{nifti} object and the output is a brain-extracted \code{nifti}
object.

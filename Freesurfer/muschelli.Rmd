...
author:
  - name: John Muschelli
    ...
    email: elizabethmargaretsweeney@gmail.com
...
```{r nu_correct_nifti, echo = FALSE, eval = TRUE, results='markup', dependson=c("watershed_plot", "reorient")}
...
![Pial surface from bert subject in Freesurfer rendered using \pkg{rgl}.](`r rgl_out_file`)
